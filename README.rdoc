...
=== Example
  ...
  ### ruby
  encoded = GoogleMapsTools::PolylineEncoder.encode([ [ 0, 0 ], [ 1, 1 ], [ 5, 5 ] ])
  puts <<-_JS
    map.addOverlay(
...
=== Examples
  ...
  p GoogleMapsTools::Projection.from_geometry_to_pixels('010100000088D51F6118704EC057B2632310D54640', 10)
  # => "010100000000000000802DF54000000000B0DAF640"
  p GoogleMapsTools::Projection.from_lng_lat_to_pixels(-60.875744, 45.664555, 10)
  # => [86744, 93611]
  p GoogleMapsTools::Projection.from_pixels_to_lng_lat(86744, 93611, 10)
...
=== Examples
  ...
  p GoogleMapsTools::QuadTree.from_lng_lat_to_quad_tree(-79.849052, 43.51968, 19)
  # => "0302231320112333113"
  p GoogleMapsTools::QuadTree.from_lng_lat_to_quad_tree(-79.849052, 43.51968, 50)
  # => "03022313201123331132332221332332311203231333300012"
